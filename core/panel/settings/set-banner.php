...
$options[] = array(
    ...
    $options[] = array(
		...
		'desc' => __('留空则不显示，地区欢迎语请使用 {USER_LOCATION} 占位符', 'ui_boxmoe_com'),
		'id' => 'boxmoe_banner_font',
		'std' => '🎉Hello! 欢迎 {USER_LOCATION} 的朋友来到盒子萌-🕊️纸鸢版！',
		'type' => 'text');
    $options[] = array(
		'name' => __('开启地区欢迎语', 'ui_boxmoe_com'),
		'desc' => __('开启后 {USER_LOCATION} 会替换为访客所在省市', 'ui_boxmoe_com'),
		'id' => 'boxmoe_banner_location_switch',
		'type' => "checkbox",
		'std' => false,
		);
    $options[] = array(
    ...
    $options[] = array(
		'name' => __('自定义一言API地址', 'ui_boxmoe_com'),
		'desc' => __('（留空则使用默认 https://v1.hitokoto.cn；填写后优先使用自定义地址，兼容 hitokoto 标准 JSON「hitokoto 字段」、自定义 JSON「data[].text」以及纯文本返回）', 'ui_boxmoe_com'),
		'id' => 'boxmoe_banner_hitokoto_api_url',
		'std' => '',
		'type' => 'text');
    $options[] = array(
		'name' => __('一言自定义切换时间', 'ui_boxmoe_com'),
		'desc' => __('（单位：秒，默认 10；建议不少于 3 秒）', 'ui_boxmoe_com'),
		'id' => 'boxmoe_banner_hitokoto_interval',
		'std' => '10',
		'class' => 'mini',
		'type' => 'text');
    $options[] = array(
